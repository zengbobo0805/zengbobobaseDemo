...
public class PainShaderActivity extends Activity {
	@Override
	...
	class MyView extends View {
		...
		public MyView(Context context) {
			...
			bitmapShader = new BitmapShader(bm, TileMode.REPEAT,
					TileMode.MIRROR);
			// 实例化线性渲染
			linearGradient = new LinearGradient(0, 0, 100, 100, colors, null,
					TileMode.REPEAT);
			// 实例化光束渲染
			radiaGradient = new RadialGradient(100, 100, 80, colors, null,
					TileMode.REPEAT);
			// 实例化梯度渲染
			sweepGradient = new SweepGradient(200, 200, colors, null);
			// 实例化混合渲染
			composeShader = new ComposeShader(linearGradient, radiaGradient,
